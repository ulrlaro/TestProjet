...
{
    public partial class SupprimerRecettesView : UserControl
    {
        ...
        private void HideRecetteInformation()
        {
            ...
            SupprimerLaRecetteButton.IsEnabled = false;
        }
        ...
        private void SupprimerLaRecetteButton_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            SuppressionConfirmationWindow suppressionConfirmationWindow = new SuppressionConfirmationWindow("Êtes-vous sûr de vouloir supprimer cette recette?");
            ...
            {
                _gestionnaireRecettes.RemoveRecette(_recetteIndex);

                if (_recetteIndex > 0 && _recetteIndex == _gestionnaireRecettes.Recettes.Count)
                    _recetteIndex--;

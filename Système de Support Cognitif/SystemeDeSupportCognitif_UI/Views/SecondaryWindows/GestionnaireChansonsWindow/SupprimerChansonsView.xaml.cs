...
{
    public partial class SupprimerChansonsView : UserControl
    {
        ...
        private void HideChansonInformation()
        {
            ...
            SupprimerLaChansonButton.IsEnabled = false;
        }
        ...
        private void SupprimerLaChansonButton_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            SuppressionConfirmationWindow suppressionConfirmationWindow = new SuppressionConfirmationWindow("Êtes-vous sûr de vouloir supprimer cette chanson?");
            ...
            {
                _gestionnaireChansons.RemoveChanson(_chansonIndex);

                if (_chansonIndex > 0 && _chansonIndex == _gestionnaireChansons.Chansons.Count)
                    _chansonIndex--;

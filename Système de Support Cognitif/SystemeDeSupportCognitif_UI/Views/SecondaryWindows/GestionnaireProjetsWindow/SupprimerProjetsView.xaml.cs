...
{
    public partial class SupprimerProjetsView : UserControl
    {
        ...
        private void HideProjetInformation()
        {
            ...
            SupprimerLeProjetButton.IsEnabled = false;
        }
        ...
        private void SupprimerLeProjetButton_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            SuppressionConfirmationWindow suppressionConfirmationWindow = new SuppressionConfirmationWindow("Êtes-vous sûr de vouloir supprimer ce projet?");
            ...
            {
                _gestionnaireProjets.RemoveProjet(_acquisitionIndex);

                if (_acquisitionIndex > 0 && _acquisitionIndex == _gestionnaireProjets.Projets.Count)
                    _acquisitionIndex--;

...
{
    public partial class SupprimerEvenementsView : UserControl
    {
        ...
        public SupprimerEvenementsView()
        {
        ...
        private void HideEvenementInformation()
        {
            ...
            SupprimerEvenementButton.IsEnabled = false;
        }
        ...
        private void SupprimerEvenementButton_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            SuppressionConfirmationWindow suppressionConfirmationWindow = new SuppressionConfirmationWindow("Êtes-vous sûr de vouloir supprimer cet événement?");
            ...
            {
                _gestionnaireEvenements.RemoveEvenement(_evenementIndex);

                if (_evenementIndex > 0 && _evenementIndex == _gestionnaireEvenements.Evenements.Count)
                    _evenementIndex--;

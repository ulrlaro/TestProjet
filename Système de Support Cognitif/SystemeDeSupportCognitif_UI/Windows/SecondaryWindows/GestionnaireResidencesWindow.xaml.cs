...
{
    public partial class GestionnaireResidencesWindow : Window
    {
        public GestionnaireResidencesWindow()
        {
            InitializeComponent();

            StateChanged += MainWindowStateChangeRaised;

            DataContext = new HomeResidencesViewModel();
        }
        ...
        private void AjouterButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new AjouterResidencesViewModel();
        }
        ...
        private void ConsulterButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new ConsulterResidencesViewModel();
        }
        ...
        private void ModifierButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new ModifierResidencesViewModel();
        }
        ...
        private void SupprimerButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new SupprimerResidencesViewModel();
        }
    }
}

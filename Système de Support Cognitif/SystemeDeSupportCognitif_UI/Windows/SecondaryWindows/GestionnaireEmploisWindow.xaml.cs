...
using SystemeDeSupportCognitif_UI.ViewModels.SecondaryWindows.GestionnaireEmploisWindow;

namespace SystemeDeSupportCognitif_UI.Windows.SecondaryWindows
{
    public partial class GestionnaireEmploisWindow : Window
    {
        public GestionnaireEmploisWindow()
        {
            InitializeComponent();

            StateChanged += MainWindowStateChangeRaised;

            DataContext = new HomeEmploisViewModel();
        }
        ...
        private void AjouterButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new AjouterEmploisViewModel();
        }
        ...
        private void ConsulterButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new ConsulterEmploisViewModel();
        }
        ...
        private void ModifierButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new ModifierEmploisViewModel();
        }
        ...
        private void SupprimerButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new SupprimerEmploisViewModel();
        }
    }
}

...
using SystemeDeSupportCognitif_UI.ViewModels.SecondaryWindows.GestionnaireRecettesWindow;

namespace SystemeDeSupportCognitif_UI.Windows.SecondaryWindows
{
    public partial class GestionnaireRecettesWindow : Window
    {
        public GestionnaireRecettesWindow()
        {
            InitializeComponent();

            StateChanged += MainWindowStateChangeRaised;

            DataContext = new HomeRecettesViewModel();
        }
        ...
        private void AjouterButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new AjouterRecettesViewModel();
        }
        ...
        private void ConsulterButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new ConsulterRecettesViewModel();
        }
        ...
        private void ModifierButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new ModifierRecettesViewModel();
        }
        ...
        private void SupprimerButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new SupprimerRecettesViewModel();
        }
    }
}

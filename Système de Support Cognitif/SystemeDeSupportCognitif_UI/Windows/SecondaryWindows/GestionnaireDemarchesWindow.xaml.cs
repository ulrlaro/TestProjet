...
using SystemeDeSupportCognitif_UI.ViewModels.SecondaryWindows.GestionnaireDemarchesWindow;

namespace SystemeDeSupportCognitif_UI.Windows.SecondaryWindows
{
    public partial class GestionnaireDemarchesWindow : Window
    {
        public GestionnaireDemarchesWindow()
        {
            InitializeComponent();

            StateChanged += MainWindowStateChangeRaised;

            DataContext = new HomeDemarchesViewModel();
        }
        ...
        private void AjouterButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new AjouterDemarchesViewModel();
        }
        ...
        private void ConsulterButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new ConsulterDemarchesViewModel();
        }
        ...
        private void ModifierButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new ModifierDemarchesViewModel();
        }
        ...
        private void SupprimerButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new SupprimerDemarchesViewModel();
        }
    }
}

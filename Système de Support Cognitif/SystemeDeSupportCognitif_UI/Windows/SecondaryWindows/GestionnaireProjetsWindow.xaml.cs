...
using SystemeDeSupportCognitif_UI.ViewModels.SecondaryWindows.GestionnaireProjetsWindow;

namespace SystemeDeSupportCognitif_UI.Windows.SecondaryWindows
{
    public partial class GestionnaireProjetsWindow : Window
    {
        public GestionnaireProjetsWindow()
        {
            InitializeComponent();

            StateChanged += MainWindowStateChangeRaised;

            DataContext = new HomeProjetsViewModel();
        }
        ...
        private void AjouterButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new AjouterProjetsViewModel();
        }
        ...
        private void ConsulterButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new ConsulterProjetsViewModel();
        }
        ...
        private void ModifierButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new ModifierProjetsViewModel();
        }
        ...
        private void SupprimerButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DataContext = new SupprimerProjetsViewModel();
        }
    }
}
